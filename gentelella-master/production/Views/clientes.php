                ...
                <div class="x_panel">
                  ...
                  <p class="warning-sucesso">
                   ...
                   <p class="warning-erro">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../Controllers/atualizarCliente.php">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Profissão<span class="required"></span>
                        </label>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="profissao" value="<?php echo $resultado->profissao; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="endereco" required="required" value="<?php echo $resultado->endereco; ?>"  class="form-control col-md-7 col-xs-12">
                         </div>
                         <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">CEP<span class="required">*</span>
                         </label>
                         <div class="col-md-2 col-sm-6 col-xs-12">
                           <input type="text" id="last-name" name="cep" required="required" value="<?php echo $resultado->cep; ?>"  class="form-control col-md-7 col-xs-12">
                      </div>
                     </div>
                     <div class="form-group">
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Telefones<span class="required">*</span>
                            </label>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="telefone1" value="<?php echo $resultado->telefone1; ?>" required="required"  class="form-control col-md-3 col-xs-12">
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="telefone2" value="<?php echo $resultado->telefone2; ?>" class="form-control col-md-3 col-xs-12">
                         </div>
                     </div>
                     <div class="form-group">
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Bairro<span class="required">*</span>
                            </label>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="bairro" value="<?php echo $resultado->bairro; ?>" required="required"  class="form-control col-md-3 col-xs-12">
                            </div>
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Cidade<span class="required">*</span>
                            </label>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="cidade" value="<?php echo $resultado->cidade; ?>" required="required" class="form-control col-md-3 col-xs-12">
                            </div>
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">UF<span class="required">*</span>
                            </label>
                            <div class="col-md-1 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="uf" required="required" value="<?php echo $resultado->uf; ?>" class="form-control col-md-3 col-xs-12">
                            </div>
                     </div>
                     <div class="form-group">
                            ...
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Email<span class="required"></span>
                            </label>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="email" value="<?php echo $resultado->email; ?>"  class="form-control col-md-3 col-xs-12">
                         </div>
                         <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Nº Habilitação<span class="required">*</span>
                            </label>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="hab" value="<?php echo $resultado->numhab; ?>" required="required"  class="form-control col-md-3 col-xs-12">
                         </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="clientes.php"><button class="btn btn-round btn-danger" type="button">Cancelar <span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></button></a>
                    ...
                    <?php else: ?>
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="../Controllers/cadastrarCliente.php">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="telefone2"  class="form-control col-md-3 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Bairro<span class="required">*</span>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="cidade" required="required" class="form-control col-md-3 col-xs-12">
                            </div>
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">UF<span class="required">*</span>
                            </label>
                            <div class="col-md-1 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="uf" required="required" class="form-control col-md-3 col-xs-12">
                            </div>
                      </div>
                      <div class="form-group">
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">CPF<span class="required">*</span>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="email"  class="form-control col-md-3 col-xs-12">
                        </div>
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="last-name">Nº Habilitação<span class="required">*</span>
                            </label>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="hab" required="required"  class="form-control col-md-3 col-xs-12">
                        </div>
                      </div>
                              ...
                              <table class="table jambo_table tabela-clientes">
                                <thead>
                                  <tr class="">
                                    ...
                                    <th class="column-title">Nº Habilitação</th>
