...
<div class="mes"> 
  <ul>
    ...
    <button onclick="proximo()" class="prev">&#10094;</button>
    <a href="calendario2.php"><button onclick="antes()" class="next">&#10095;</button></a>
    <li> <?php echo $mes1->getNome() ?> <br><span style="font-size:18px"> <?php  echo ucwords(strftime("%Y")); ?> </span></li>
  </ul>
</div>
