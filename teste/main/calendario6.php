...
<div class="mes"> 
  <ul>
    ...
    <a href="calendario5.php"><button onclick="proximo()" class="prev">&#10094;</button></a>
    <a href="calendario7.php"><button onclick="antes()" class="next">&#10095;</button></a>
    <li> <?php echo $mes6->getNome() ?> <br><span style="font-size:18px"> <?php  echo ucwords(strftime("%Y")); ?> </span></li>
  </ul>
</div>
